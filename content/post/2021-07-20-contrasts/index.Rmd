...
This post is an overview of how factors (i.e. categorical variables) are coded under the hood using dummy coding and which types of dummy coding can be set in R.^[A previous version of this post is also featured as a vignette in the learnB4SS package, <https://learnb4ss.github.io/learnB4SS/articles/contrasts.html>]
