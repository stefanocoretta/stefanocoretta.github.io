...
Finally, **a scientific theory can be defined as a generally-recognised set of well-corroborated hypotheses that form an integrated model of one or more natural phenomena** [@nrc2008, pp. 32--36].[^1]
