...
categories: ["Statistics", "Regression models"]
...
**Regression models**, aka linear regression models or regression models, are a group of statistical models based on the simple idea that we can predict an outcome variable $Y$ based on a function $f(X)$.
